...
export const LocationInput: React.FC<LocationInputProps> = ({ onLocationSubmit, inputMethod }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
      <h2 className="text-2xl font-semibold mb-6 text-green-800">  {inputMethod === 'upload' ? 'Upload Tree Image' : 'Enter Tree Location'}</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-green-500 focus:border-green-500"
            rows={3}
            placeholder="Enter a message about this tree"
          />
        </div>
